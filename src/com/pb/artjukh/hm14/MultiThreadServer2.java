    ...
    public class MultiThreadServer2 {
        ...
        class ClientServiceThread extends Thread {
            ...
            public void run() {
                ...
                System.out.println("Accepted clinet Address - " + myClientSocket.getInetAddress().getHostName());
                try {
                    ...
                    while (m_bRunThread) {
                        ...
                        System.out.println("clinet Says :" + clientCommand);
                        out.println("Server answer "+ clientCommand);
